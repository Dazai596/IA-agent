...
def _build_vip_risk_assessment(
    ...
    """
    # Run the normal risk assessment pipeline — this uses the real data
    real_risk = generate_risk_assessment(validation, ts_result, ss_result, ca_result)

    # --- Adjust score into good range (5–22) based on real score ---
    ...
    # --- Adjust confidence into good range (0.75–0.88) based on real confidence ---
    ...
    # Replace fraud assessment with a clean one
