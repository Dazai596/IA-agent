...
def _find_header_row(df: pd.DataFrame) -> int:
    ...
    """
    # "activity", "active", and "active_time" are all valid names for the
    # activity-percentage column depending on the HiveDesk export version.
    required_keywords = {"duration", "activity", "active", "active_time"}
    helpful_keywords = {"project", "task", "member", "worksession", "time start", "time end", "date"}
