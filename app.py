...
if not run_button and st.session_state.report is None:
    ...
    <div style="text-align:center; padding: 2.5rem 2rem 1.5rem;">
        ...
        <h2 class="landing-title">Freelancer Work Audit System</h2>
        <p class="landing-desc">
            Upload a timesheet and/or screenshot report to analyze work patterns
            and generate a detailed audit report.
        </p>
    </div>
    """, unsafe_allow_html=True)
    ...
    st.markdown("""
    <div class="guide-box">
        <h4>📖 How to run an audit</h4>

        <div class="guide-step">
            <div class="guide-num">1</div>
            <div class="guide-text">
                <strong>Export your files from HiveDesk</strong><br>
                <span class="muted">
                    Go to HiveDesk &rarr; Reports &rarr; export the <strong>Timesheet Detail</strong> as .xls or .csv.
                    If you have screenshots enabled, export the <strong>Screenshot Report</strong> as .pdf.
                </span>
            </div>
        </div>
        ...
        <div class="guide-step">
            ...
            <div class="guide-text">
                <strong>Upload the files in the sidebar</strong><br>
                <span class="muted">
                    Use the file uploaders on the left panel. You can upload both files for a full cross-analysis,
                    or just the timesheet for a timesheet-only audit.
                </span>
            </div>
        </div>
        ...
        <div class="guide-step">
            ...
            <div class="guide-text">
                <strong>Click "▶ Run Audit"</strong><br>
                <span class="muted">
                    The system will parse your files, analyze the data, cross-reference the sources,
                    and generate a full report with a work summary and risk assessment.
                </span>
            </div>
        </div>
        ...
        <div class="guide-step">
            ...
            <div class="guide-text">
                ...
                <span class="muted">
                    The report starts with a plain-language <strong>Work Summary</strong> that describes what the freelancer
                    did during the period. Below it you will find detailed metrics, charts, anomalies,
                    and a downloadable JSON report.
                </span>
            </div>
        </div>
    </div>
    ...
    st.markdown("")
    st.markdown("""
    <div class="guide-box" style="margin-top:0.5rem;">
        <h4>💡 What does the report tell you?</h4>
        <p style="color:var(--audit-text-muted);font-size:0.9rem;margin:0;">
            ...
            It does <strong>not</strong> judge working hours: freelancers can work at any time they choose.
...
if report.work_summary:
    st.markdown('<div class="section-header">📝 Work Summary</div>', unsafe_allow_html=True)
    st.markdown(
        f'<div class="summary-box">{report.work_summary}</div>',
        unsafe_allow_html=True,
    )
